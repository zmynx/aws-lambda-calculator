        ...
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <ul className="flex flex-wrap space-x-4 lg:space-x-6">
              ...
              <li><Link to="/comparison" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 font-medium">VS AWS Tools</Link></li>
              ...
              <li><Link to="/demo" className="hover:text-white dark:hover:text-white bg-blue-600 dark:bg-blue-600 hover:bg-blue-700 dark:hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 px-4 py-2 rounded-lg font-semibold transition-colors duration-200 shadow-md">Demo</Link></li>
