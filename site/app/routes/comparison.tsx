          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 rounded-xl border border-green-200 dark:border-green-800 overflow-hidden">
            ...
            <div className="p-6">
              <div className="text-center mb-4">
                <div className="text-3xl font-bold text-green-600 dark:text-green-400">$106.99</div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">$106.67</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between border-t pt-2 font-semibold">
                  ...
                  <span className="text-green-600 dark:text-green-400">$106.99</span>
                </div>
              </div>
