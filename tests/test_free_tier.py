...
class TestFreeTier:
    ...
    def test_free_tier_usage_under_all_limits(self):
        ...
        assert (
            "500000 requests - 1000000 free tier requests = 0 monthly billable requests"
            in steps_text
        )
    ...
    def test_free_tier_requests_over_limit(self):
        ...
        steps_text = " ".join(result.calculation_steps)
        assert (
            "1500000 requests - 1000000 free tier requests = 500000 monthly billable requests"
            in steps_text
        )
        assert (
            "500000 requests x" in steps_text
        )  # Should show billing for excess requests
    ...
    def test_free_tier_compute_over_limit(self):
        ...
        steps_text = " ".join(result.calculation_steps)
        assert (
            "1000 requests - 1000000 free tier requests = 0 monthly billable requests"
            in steps_text
        )
    ...
    def test_free_tier_both_limits_exceeded(self):
        ...
        assert (
            "2000000 requests - 1000000 free tier requests = 1000000 monthly billable requests"
            in steps_text
        )
        assert "free tier GB-s" in steps_text
        assert "billable GB-s" in steps_text
        ...
        assert (
            "Monthly compute charges:" in steps_text
            and "0.0 USD" not in result.calculation_steps[-5]
        )  # Compute charges
    ...
    def test_free_tier_edge_case_exact_limits(self):
        ...
        assert (
            "1000000 requests - 1000000 free tier requests = 0 monthly billable requests"
            in steps_text
        )
    ...
    def test_free_tier_calculation_steps_content(self):
        ...
        request_step_found = any(
            "1200000 requests - 1000000 free tier requests" in step for step in steps
        )
    ...
    def test_free_tier_high_usage_scenario(self):
        ...
        assert (
            "10000000 requests - 1000000 free tier requests = 9000000 monthly billable requests"
            in steps_text
        )
        assert "free tier GB-s" in steps_text
